...
class Prestaxmlexportolx extends Module
{
    ...
    {
        Configuration::updateValue('PRESTAXMLEXPORTOLX_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('PRESTAXMLEXPORTOLX_LIVE_MODE');
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitPrestaxmlexportolxModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'PRESTAXMLEXPORTOLX_LIVE_MODE',
                        'is_bool' => true,
                    ...
                    array(
                        ...
                        'name' => 'PRESTAXMLEXPORTOLX_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'PRESTAXMLEXPORTOLX_ACCOUNT_PASSWORD',
